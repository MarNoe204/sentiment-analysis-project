...
def run_file_prediction(
    input_path: str, output_path: str, model_path: str = MODEL_PATH
) -> None:
...
def main(
    ...
    if input_file and output_file:
        ...
        print(
            "Fehler: Bitte geben Sie entweder Text zur Analyse ODER --input und --output Dateipfade an."
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", default=MODEL_PATH, help="Pfad zur trainierten Pipeline-Datei."
    )
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help="Ein oder mehrere direkt zu bewertende Texte.",
    )
